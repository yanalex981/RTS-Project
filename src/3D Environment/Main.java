...
public class Main 
{
	...
	int FPS;
	boolean keyUP, keyDOWN, keyLEFT, keyRIGHT, keySPACE, keyLSHIFT, keyW, keyA, keyS, keyD, keyLightMove;
    ArrayList<Unit> unitList = new ArrayList<Unit>();
    Vector3f globalPosition = new Vector3f(0, 0, 0), globalRotation = new Vector3f(45, 45, 0);
	...
	public void updateInput(int delta) 
	{
		...
		keySPACE = Keyboard.isKeyDown(Keyboard.KEY_LSHIFT);
		keyLSHIFT = Keyboard.isKeyDown(Keyboard.KEY_SPACE);
		...
		if(keyUP)
		{
			tMatrix.translate(new Vector3f( (float)(delta * -0.01 * 0.707), 
											0, 
											(float)(delta * 0.01 * 0.707)));
		}
		if(keyDOWN)
		{
			tMatrix.translate(new Vector3f( (float)(delta * 0.01 * 0.707), 
