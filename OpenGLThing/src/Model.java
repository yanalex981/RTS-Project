...
public class Model
{
	...
	{
		//float minX = verticies.get(1).x, minY = verticies.get(1).y, minZ = verticies.get(1).z, maxX = verticies.get(1).x, maxY = verticies.get(1).y, maxZ = verticies.get(1).z;
		...
		maskFaces.add(new QuadFace(new Vector4f(0, 1, 2, 3), new Vector4f(0, 0, 0, 0)));
		maskFaces.add(new QuadFace(new Vector4f(4, 5, 6, 7), new Vector4f(0, 0, 0, 0)));
		maskFaces.add(new QuadFace(new Vector4f(0, 1, 4, 5), new Vector4f(0, 0, 0, 0)));
		maskFaces.add(new QuadFace(new Vector4f(2, 3, 6, 7), new Vector4f(0, 0, 0, 0)));
		maskFaces.add(new QuadFace(new Vector4f(0, 2, 4, 6), new Vector4f(0, 0, 0, 0)));
		maskFaces.add(new QuadFace(new Vector4f(1, 3, 5, 7), new Vector4f(0, 0, 0, 0)));
	}
